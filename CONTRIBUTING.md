...
Copyright (c) 2018 The ReCoal Project.
...
The "ReCoal Maintainer Team" is defined in this document as the following users:
- pranav130100
- deep-recoal
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to ReCoal code or ReCoal's dependency code or ReCoal's potential/future dependency code or research which successfully implements ReCoal.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the ReCoal Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the ReCoal Maintainer Team.
